...
// var GAME_LOCATION = 'https://ttt-ultimate.firebaseio.com/';
...
/////////////////////////////////////////////// ---- > FIREBASE (Try Later)
  ...
  $scope.remote_Player_Names.$bind($scope, "Player_Names");
  $scope.$watch("Player_Names", function() {
    return false;
  });
